...
samples.df<-read.csv("newfilewithpairedcolumn.csv",row.names = "X")
```
...
```{r}
# Sort prey into the 20 most common
...
# Plot paired samples read proportions by sharkspecies prey genus
...
```{r}
#Now break this up so its by shark species and they are next to eachother

#Now only by shark species (Atlantic sharpnose)
NC_Shark_prey_species_merge.ps_paired.1_top20species.AtlanticSharpnose<-subset_samples(NC_Shark_prey_species_merge.ps_paired.1_top20species,Species..scientific.name.=="Rhizoprionodon terraenovae")

NC_Shark_prey_species_merge.ps_paired.1_top20species.AtlanticSharpnose_plot<-plot_bar(NC_Shark_prey_species_merge.ps_paired.1_top20species.AtlanticSharpnose,x="Species..scientific.name.", fill="species") + 
...
NC_Shark_prey_species_merge.ps_paired.1_top20species.AtlanticSharpnose_plot
